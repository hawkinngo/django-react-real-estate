# Generated by Django 3.2.7 on 2022-06-28 01:56
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', django_countries.fields.CountryField(default='VI', max_length=2, verbose_name='Country')),
                ('city', models.CharField(default='Sai Gon', max_length=180, verbose_name='City')),
                ('postal_code', models.CharField(default='70000', max_length=100, verbose_name='Postal Code')),
                ('street_address', models.CharField(default='Tran Hung Dao', max_length=180, verbose_name='Street Address')),
                ...
                ('advert_type', models.CharField(choices=[('For Sale', 'For Sale'), ('For Rent', 'For Sale'), ('Auction', 'Auction')], default='For Sale', max_length=50, verbose_name='Advert Type')),
                ...
                ('cover_photo', models.ImageField(blank=True, default='/properties/house_sample.jpg', null=True, upload_to='properties/', verbose_name='Main Photo')),
                ('photo1', models.ImageField(blank=True, default='/properties/interior_sample.jpg', null=True, upload_to='')),
                ('photo2', models.ImageField(blank=True, default='/properties/interior_sample.jpg', null=True, upload_to='')),
                ('photo3', models.ImageField(blank=True, default='/properties/interior_sample.jpg', null=True, upload_to='')),
                ('photo4', models.ImageField(blank=True, default='/properties/interior_sample.jpg', null=True, upload_to='')),
