...
class Property(TimeStampedUUIDModel):
    ...
    country = CountryField(
        verbose_name=_("Country"), default="VI", blank_label="(Select Country)"
    )
    city = models.CharField(verbose_name=_("City"), max_length=180, default="Sai Gon")
    postal_code = models.CharField(
        verbose_name=_("Postal Code"), max_length=100, default="70000"
    )
    street_address = models.CharField(
        verbose_name=_("Street Address"), max_length=180, default="Tran Hung Dao"
    )
    ...
    def final_property_price(self):
        ...
        tax_mount = round(tax_percentage * property_price, 2)
        price_after_tax = float(round(property_price + tax_mount, 2))
